...
//        x축, y축 이동속도
            ...
            if(distanceX > 0 && distanceY / distanceX > -1 && distanceY / distanceX < 1){
                //            오른쪽 이미지 출력
                state = 0;
            }
//            else if(distanceY / distanceX > -1 && distanceX / distanceY < 1){
//                //            왼쪽 이미지 출력
//            }
            else if(distanceY < 0 && (distanceY / distanceX < -1 || distanceY / distanceX > 1)){
                //            위쪽 이미지 출력
                state = 1;
            }
            else if(distanceY > 0 && (distanceY / distanceX < -1 || distanceY / distanceX > 1)){
